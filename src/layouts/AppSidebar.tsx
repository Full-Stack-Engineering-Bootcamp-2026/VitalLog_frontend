...
export function AppSidebar() {
  ...
  <div className="flex items-center gap-3">
    ...
    {!isCollapsed && (
      ...
      {/* Footer */}
      <SidebarFooter className="border-t border-gray-200 px-2 py-4 space-y-1">

        {/* Log New Activity button */}
        <button
          className={`flex w-full items-center gap-2 rounded-lg bg-green-600 px-3 py-2.5 text-sm font-medium text-white hover:bg-green-700 transition-colors ${
        ...
        <SidebarMenu className="space-y-1 pt-1">
          ...
          <SidebarMenuItem>
            <SidebarMenuButton
              className="w-full rounded-lg px-3 py-2.5 text-sm font-medium text-gray-600 hover:bg-gray-100 hover:text-gray-900 transition-colors"
            >
          ...
          <SidebarMenuItem>
            <SidebarMenuButton
              ...
              className="w-full rounded-lg px-3 py-2.5 text-sm font-medium text-gray-600 hover:bg-red-50 hover:text-red-500 transition-colors"
            >
